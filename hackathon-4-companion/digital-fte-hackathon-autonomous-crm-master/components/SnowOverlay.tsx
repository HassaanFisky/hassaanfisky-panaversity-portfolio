...
export function SnowOverlay() {
  ...
  useEffect(() => {
    ...
    window.addEventListener("snow-toggle" as any, handleToggle); // H4 compatibility
    
    // Fallback theme detection for H4 (without next-themes)
    const checkTheme = () => {
    ...
    return () => {
        window.removeEventListener("toggle-snow" as any, handleToggle);
        window.removeEventListener("snow-toggle" as any, handleToggle);
        observer.disconnect();
