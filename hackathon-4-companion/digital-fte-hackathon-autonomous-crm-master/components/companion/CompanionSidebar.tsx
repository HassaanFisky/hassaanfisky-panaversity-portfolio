...
/**
 * CompanionSidebar — Left pane of the Companion Window.
 *
 * Desktop : inline 240 px panel, collapses to 0 with spring width animation.
 * Mobile  : absolute overlay drawer (CompanionWindow handles the positioning;
 *           swipe-to-dismiss drag is wired in CompanionWindow via Framer drag).
 *
 * Contents:
 *   • Header row: "CHATS" label + collapse button
