...
/**
 * SessionHistoryItem — Single row in the Companion sidebar session list.
 * Shows session title, relative timestamp, and a hover-reveal delete button.
 */
...
export function SessionHistoryItem({
  ...
  return (
    <motion.div
      ...
      className={`
        relative flex items-start gap-2 px-3 py-2.5 rounded-xl cursor-pointer
        group select-none
        ${
          isActive
