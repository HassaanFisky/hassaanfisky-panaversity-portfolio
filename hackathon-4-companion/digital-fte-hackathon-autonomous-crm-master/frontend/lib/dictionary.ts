 ...
 * Language Protocol: English, Urdu, Roman Urdu
 */
...
export const translations = {
  en: {
    ...
    hero: {
      ...
      description: "The Companion FTE bridges the gap between efficiency and empathy. Deploy intelligent agents that resolve tickets across all channels while preserving your brand's warmth.",
    ...
    features: {
      ...
      description: "Built with care to handle your most delicate customer interactions with precision and empathy.",
      items: [
        {
  ...
  ur: {
    ...
    hero: {
      ...
      description: "کمپینین ایف ٹی ای کارکردگی اور ہمدردی کے درمیان فرق کو ختم کرتا ہے۔ ایسے ذہین ایجنٹس تعینات کریں جو آپ کے برانڈ کی گرمجوشی کو برقرار رکھتے ہوئے تمام چینلز پر ٹکٹ حل کریں۔",
    ...
    features: {
      ...
      description: "آپ کے انتہائی نازک کسٹمر تعاملات کو درستگی اور ہمدردی کے ساتھ سنبھالنے کے لئے احتیاط سے بنایا گیا ہے۔",
      items: [
        {
  ...
  ru: {
    ...
    hero: {
      ...
      description: "Companion FTE efficiency aur empathy ke darmiyan farq ko khatam karta hai. Aisay intelligent agents deploy karein jo aap ke brand ki garmajosh ko barqarar rakhte hue tamam channels par tickets resolve karein.",
    ...
    features: {
      ...
      description: "Aap ke intehai nazuk customer interactions ko darustagi aur hamdardi ke sath sambhalnay ke liye aehtiyat se banaya gaya hai.",
      items: [
        {
