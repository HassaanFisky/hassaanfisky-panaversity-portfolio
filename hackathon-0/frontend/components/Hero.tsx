 ...
 * Corrected for 100% Theme Fidelity.
 */
export function Hero() {
  ...
  return (
    <section className="relative min-h-[95vh] flex flex-col items-center justify-center pt-32 pb-24 md:pb-32 overflow-hidden bg-bg-base transition-colors duration-500">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-7xl h-full pointer-events-none opacity-[0.04] dark:opacity-[0.08]">
      ...
      >
        <MotionDiv variants={fadeUp} className="space-y-10">
          <div className="inline-flex items-center gap-3 px-5 py-2 rounded-full bg-accent/5 border border-accent/20 text-[10px] font-bold uppercase tracking-[0.4em] text-accent mb-6 shadow-sm">
          ...
          <p className="prose-editorial text-xl md:text-3xl max-w-3xl mx-auto leading-relaxed text-text-secondary/80 font-serif italic mb-16">
        ...
        <MotionDiv variants={fadeUp} className="flex flex-col sm:flex-row items-center justify-center gap-10">
          <button 
            ...
            className="btn-tactile group px-12 py-6 bg-accent text-white rounded-2xl font-bold text-[14px] uppercase tracking-widest flex items-center gap-4 shadow-float shadow-accent/20 transition-all hover:-translate-y-1 active:translate-y-0"
          >
            <span>Explore Blueprint</span>
            <ArrowRight className="w-5 h-5 group-hover:translate-x-1.5 transition-transform duration-300" />
          </button>
          
          <div className="flex items-center gap-10 px-10 py-5 bg-bg-surface/60 backdrop-blur-md border border-border-fine rounded-2xl shadow-soft">
            <div className="flex items-center gap-5">
              <div className="w-12 h-12 rounded-xl bg-accent/10 flex items-center justify-center text-accent shadow-sm border border-accent/10 transition-transform hover:scale-110">
                <Trophy size={24} strokeWidth={2.5} />
              </div>
              <div className="text-left">
                <div className="text-3xl font-serif text-text-primary font-bold leading-none tracking-tight">{completedPoints}</div>
                <div className="text-[10px] uppercase tracking-[0.3em] font-bold text-text-muted mt-2 opacity-60">Total XP</div>
              </div>
            </div>
            
            <div className="h-10 w-[1px] bg-border-fine opacity-50" />
            
            <div className="flex items-center gap-5">
              <div className="w-12 h-12 rounded-xl bg-accent/5 flex items-center justify-center text-accent/70 shadow-sm border border-accent/5 transition-transform hover:scale-110">
                <Database size={24} strokeWidth={2.5} />
              </div>
              <div className="text-left">
                <div className="text-3xl font-serif text-text-primary font-bold leading-none tracking-tight">5/5</div>
                <div className="text-[10px] uppercase tracking-[0.3em] font-bold text-text-muted mt-2 opacity-60">Registry</div>
              </div>
            </div>
          </div>
        </MotionDiv>
      ...
      >
        <span className="text-[9px] tracking-[0.4em] uppercase font-bold text-text-muted/40">Blueprint Descent</span>
