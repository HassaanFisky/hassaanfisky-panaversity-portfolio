  ...
  return (
    <section className="relative min-h-[95vh] flex flex-col items-center justify-center pt-32 pb-24 md:pb-32 overflow-hidden bg-bg-base transition-colors duration-500">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
        ...
        />
        <div className="absolute top-[20%] left-[10%] w-[400px] h-[400px] bg-accent/10 rounded-full blur-[120px] animate-pulse" />
      ...
      >
        ...
        <MotionDiv variants={fadeUp} className="flex flex-col sm:flex-row items-center justify-center gap-12">
          ...
          <div className="flex items-center gap-12 px-10 py-6 glass-apple border-white/20 rounded-[2rem] shadow-float">
            <div className="flex items-center gap-5 group">
              <div className="w-14 h-14 rounded-2xl bg-accent/10 border border-accent/30 flex items-center justify-center text-accent shadow-sm transition-all group-hover:scale-110 group-hover:-rotate-12">
                <Trophy size={28} strokeWidth={2.5} />
              </div>
              <div className="text-left">
                <div className="text-4xl font-serif text-text-primary font-black leading-none tracking-tighter">{completedPoints}</div>
                <div className="text-[9px] uppercase tracking-[0.4em] font-black text-text-muted mt-2.5">Total Points</div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-5 group">
              ...
              <div className="text-left">
                <div className="text-4xl font-serif text-text-primary font-black leading-none tracking-tighter">5/5</div>
                <div className="text-[9px] uppercase tracking-[0.4em] font-black text-text-muted mt-2.5">Projects Live</div>
              </div>
            </div>
          </div>
        </MotionDiv>
        ...
        >
          <div className="flex flex-col items-center gap-4 opacity-40 hover:opacity-100 transition-opacity cursor-pointer"
               onClick={() => document.getElementById("hackathon-grid")?.scrollIntoView({ behavior: "smooth" })}>
            <span className="text-[8px] tracking-[0.6em] uppercase font-black text-text-muted">Scroll to explore</span>
            <div className="w-[2px] h-20 bg-gradient-to-b from-accent to-transparent animate-bounce" />
          </div>
        </MotionDiv>
      </MotionDiv>
    </section>
